...
| 文件 | 内容 |
| --- | --- |
| [tools-reference.md](./tools-reference.md) | **70 个工具完整目录**，每条带签名，按读 / 写 / 删分组 |
...
| [publishing.md](./publishing.md) | PyPI / TestPyPI 发版流程（token、pypirc、uv publish、Trusted Publishing） |

## 推荐阅读顺序

1. 顶层 [README.md](../README.md) — 安装、认证、MCP 客户端配置、安全守门。
2. 本文件 — 知道遇到问题该翻哪一份。
3. [tools-reference.md](./tools-reference.md) — 看完整的 70 工具签名。
