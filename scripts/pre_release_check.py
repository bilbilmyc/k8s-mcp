...
EXPECTED_SOURCE_TOOL_COUNT = 90
EXPECTED_MCP_TOOL_COUNT = 91
DOC_TOOL_COUNT_MARKERS = {
    "README.md": "**91 个**工具",
    "README.en.md": "**91 tools**",
    "docs/README.md": "**91 个工具**",
    "docs/README.en.md": "**91 tools**",
    "docs/tools-reference.md": "# 工具参考（91 个，按功能分类）",
}
